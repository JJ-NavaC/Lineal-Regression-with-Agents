...
public class DG_Agent extends Agent {
    ...
    // Setters
    public void setSetX_(String[] _setX) {
        this.setX_ = _setX;
    }
    ...
    public void setX_(int i, int _x) {
        try {
            this.x_[i] = Integer.valueOf(_x);
        } catch (Exception e) {
            // TODO: handle exception
        }
    }

    public void setY_(int i, int _y) {
        try {
            this.y_[i] = Integer.valueOf(_y);
        } catch (Exception e) {
            // TODO: handle exception
        }
    }
